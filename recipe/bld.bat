...
cmake -S "%SRC_DIR%" -B build -DPython3_EXECUTABLE="%PYTHON%" -G Ninja -DFABM_EXTRA_INSTITUTES=ogs -DFABM_OGS_BASE="%SRC_DIR%\extern\ogs" -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX="%PREFIX%" %CMAKE_ARGS%
